...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2 bg-white rounded-lg shadow p-6">
        ...
        <div class="space-y-6">
            ...
            <div class="border-b pb-6">
                <h3 class="text-lg font-bold text-black-blue mb-4 flex items-center gap-2">
                    <i class="fas fa-users text-my-green"></i>Travailleurs ({{ $travailleurs->count() }})
                </h3>
                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y">
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="px-4 py-8 text-center text-gray-500">Aucune donnée disponible</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
            ...
            <div>
                <h3 class="text-lg font-bold text-black-blue mb-4 flex items-center gap-2">
                    <i class="fas fa-file-contract text-my-green"></i>Demandes ({{ $demandes->count() }})
                </h3>
                <div class="space-y-2">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="space-y-3">
                <div class="flex items-center justify-between">
                    ...
                    <span class="text-2xl font-bold text-my-green">{{ $travailleurs->count() }}</span>
                </div>
                <div class="flex items-center justify-between">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <span class="text-2xl font-bold text-red-600">{{ $demandes->where('statut', 'rejetee')->count() }}</span>
                </div>
            </div>
        </div>
