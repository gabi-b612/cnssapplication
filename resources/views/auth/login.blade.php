...
<head>
    ...
    <title>Connexion - CNSS Gestionnaire RH</title>
...
<body class="bg-gradient-to-br from-black-blue via-black-blue to-my-green/80 min-h-screen flex items-center justify-center font-sans antialiased p-4">
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-xl shadow-2xl p-8">
            <h2 class="text-2xl font-semibold text-black-blue mb-6">Connexion Gestionnaire RH</h2>
        ...
        <div class="mt-6 text-center">
            <a href="{{ route('entreprise.login') }}" class="text-gray-300 text-sm hover:text-white transition-colors">
