...
<head>
    ...
    <title>Connexion Entreprise - CNSS</title>
...
<body class="bg-gradient-to-br from-black-blue via-black-blue to-my-green/80 min-h-screen flex items-center justify-center font-sans antialiased p-4">
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-300 text-sm">Espace Employeur</p>
        </div>

        <div class="bg-white rounded-xl shadow-2xl p-8">
            <h2 class="text-2xl font-semibold text-black-blue mb-6">Connexion Entreprise</h2>
            ...
            <form action="{{ route('entreprise.login.post') }}" method="POST" class="space-y-4">
                @csrf
